...
class Route {
  ...
  blocksTravelled() {
    ...
    debugger
    console.log( (endHorizontal - startHorizontal) + (this.endingLocation.vertical - this.startingLocation.vertical))
    return (endHorizontal - startHorizontal) + (this.endingLocation.vertical - this.startingLocation.vertical)
  }
}
